...
def add_to_name_space(name_space:NameFinder) -> None:
    ...
    gloves = Target(
        name="thick gloves",
        aliases=["gloves"],
        description=Description[PlainTextContext](PlainTextContext("a pair of thick-hide gloves"), PlainTextDescription()),
        states=sdg,
        weight=2,
        value=3,
        size=1,
        ...
        state_responses={
            name_space.get_from_id("held",     "state") : StaticResponse("The gloves feel tough yet warm."),
