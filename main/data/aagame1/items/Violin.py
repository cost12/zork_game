...
def add_to_name_space(name_space:NameFinder) -> None:
    ...
    violin = Target(
        ...
        state_responses={
            name_space.get_from_id("taken",  "state") : StaticResponse("As you reach for the violin, a foreboding gravitas domineers you, and you gain a peripheral grasp on the depth of the instrument's storied past."),
