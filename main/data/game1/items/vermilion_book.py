...
def add_to_name_space(name_space:NameFinder) -> None:
    ...
    book = Target(
        name="vermilion book",
        aliases=["book"],
        description_context=PlainTextContext("a lovely book with a distinctly vermilion cover"),
        ...
        target_info=TargetInfo(
            ...
            state_responses={
                name_space.get_from_id("held",   "state") : plain_text_description("You take the Vermilion Book."),
