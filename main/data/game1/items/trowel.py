...
def add_to_name_space(name_space:NameFinder) -> None:
    ...
    trowel = Target(
        ...
        target_info=TargetInfo(
            states=sdg,
            tool_responses={
                name_space.get_from_id("dig",   "action") : plain_text_description("You try to dig but give it up quickly as a bad job. There is no treasure buried here.")
            },
            target_responses={
                name_space.get_from_id("break", "action") : plain_text_description("You can't break the trowel.")
            },
            state_responses={
