...
def add_to_name_space(name_space:NameFinder) -> None:
    ...
    book = Target(
        name="gray book",
        aliases=["book"],
        description_context=PlainTextContext("a weather-worn little tome with a gray cover"),
        ...
        target_info=TargetInfo(
            states=sdg,
            target_responses={
                name_space.get_from_id("read",  "action") : plain_text_description("You try to read the book, but its script is one which you can neither recognize nor decipher. On the very last page is a note that says 'Property of Miles Harrison and Griffin Gould'.")
            },
            state_responses={
                name_space.get_from_id("held",   "state") : plain_text_description("You take the Gray Book."),
