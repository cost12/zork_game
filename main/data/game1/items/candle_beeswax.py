...
def add_to_name_space(name_space:NameFinder) -> None:
    sdg = sdg_from_parts(
        ...
        state_graphs      =[name_space.get_from_id("takeable sg", "stategraph"),
                            name_space.get_from_id("lightable sg", "stategraph"),
                            name_space.get_from_id("breakable sg", "stategraph")],
    ...
    candle = Target(
        name="beeswax candle",
        aliases=["candle"],
        description_context=PlainTextContext("a simple pale, beeswax candle"),
