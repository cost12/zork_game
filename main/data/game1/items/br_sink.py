...
def add_to_name_space(name_space:NameFinder) -> None:
    ...
    sink = Target(
        name="sink",
        description=Description[PlainTextContext](PlainTextContext("a stained ceramic sink"), PlainTextDescription()),
        states=sdg,
        weight=50,
        value=5,
        size=30,
        ...
        state_responses={
            ...
            name_space.get_from_id("broken", "state") : StaticResponse("What are you, part of a demolition crew? The sink shatters.")
        }
    )
