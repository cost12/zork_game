...
def add_to_name_space(name_space:NameFinder) -> None:
    ...
    book = Target(
        ...
        description_context=PlainTextContext("a nice paperback with a garish yellow slip"),
        ...
        target_info=TargetInfo(
            ...
            state_responses={
                name_space.get_from_id("held",   "state") : plain_text_description("You take the Yellow Book."),
