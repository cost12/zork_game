...
def add_to_name_space(name_space:NameFinder) -> None:
    child = LocationDetail(
        ...
        #children=[StandIn("beeswax candle", "target"),StandIn("small candle", "target"),StandIn("square candle", "target"),StandIn("thin candle", "target"),StandIn("squat candle", "target")] TODO
    )
