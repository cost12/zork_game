...
def add_to_name_space(name_space:NameFinder) -> None:
    location = Location(
        name="Crystal Cave",
        description_context=PlainTextContext("You stand in a natural wonder, the center of a huge spherical geode. Gleaming crystals cover every surface, refracting light from every angle and showing your shattered reflection a thousand times over. Your breath is taken away by the overwhelming beauty."),
