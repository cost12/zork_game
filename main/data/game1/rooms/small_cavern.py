...
def add_to_name_space(name_space:NameFinder) -> None:
    location = Location(
        name="Small Cavern",
        description_context=PlainTextContext("You enter a small oblong cavern with rocky walls. A strange fragrant smell wafts through the overpowering odor of bat guano."),
