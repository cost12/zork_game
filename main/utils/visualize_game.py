...
from models.state           import StateGroup
from factories.data_read_in import read_in_game, read_in_actions, read_in_states, read_in_state_graphs
...
def visualize_graph(edges:list[tuple[str,str,str]], ax) -> None:
    G = nx.MultiDiGraph()
